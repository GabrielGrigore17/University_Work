...
Enemy::Enemy(const BackBuffer* pBackBuffer)
{
	...
	m_pSprite = new Sprite("data/spaceship2.bmp", RGB(0xff, 0xff, 0xff));
	...
	bullet = new Sprite("data/downBullet.bmp", RGB(0x00, 0x00, 0x00));
	bullet->setBackBuffer(pBackBuffer);
	m_bullet = false;

	bullet2 = new Sprite("data/downBullet.bmp", RGB(0x00, 0x00, 0x00));
